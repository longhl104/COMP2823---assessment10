...
public class UnionBox implements UnionInterface {
    ...
    */
    public static Coordinate[] GetCoordinateArray(ArrayList<Coordinate> arr)
    {
        Object[] objArr = arr.toArray();
        Coordinate[] res = Arrays.copyOf(objArr, objArr.length, Coordinate[].class);
        return res;
    }
